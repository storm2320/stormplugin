...
def autoConfig(msg='', TxtColor='0xFFFFFFFF', Font='font12', BorderWidth=10):
	class MyWindow(xbmcgui.WindowDialog):
		...
		def __init__(self,msg='',L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font12',BorderWidth=10):
			...
			header = '[COLOR %s][B]Advanced Settings Konfigurator[/B][/COLOR]' % (COLOR2)
...
def firstRun():
	class MyWindow(xbmcgui.WindowXMLDialog):
		def __init__(self, *args, **kwargs):
			...
			self.msg   = "Aktuell ist kein Build von %s installiert.[CR][CR]Waehle '[B][COLOR blue]Build Menu[/COLOR][/B]' um ein Build zu installieren oder '[B][COLOR blue]Ignorieren[/COLOR][/B]' um den Hinweis zu schliessen.\n\nDanke das du den  %s verwendest." % (ADDONTITLE, ADDONTITLE)
