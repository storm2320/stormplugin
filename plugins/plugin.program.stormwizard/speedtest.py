...
I1IiI = 'plugin.program.kus-allinone-wizard'
...
def i1Ii1i1I11Iii ( list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
 ...
 OoO0O00O0oo0O = [ ' ' , ' ' , ' ' ]
 I1i1i1 . create ('[COLOR white]Storm Wizard [B]Speed Test[/B][/COLOR]' , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
...
class O0iIiIIIIIii ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  OOo = xbmcgui . Dialog ( )
  OOo . ok ( "[COLOR white]Storm Wizard [B]Speed Test[/COLOR][/B]" ,"[COLOR white][B]7Mbps[/B][/COLOR] [COLOR blue]und weniger sind fuer SD-Streams ok [/COLOR]", "[COLOR white][B]10-15Mbps[/B][/COLOR] [COLOR blue]sind fuer HD-Streams ok[/COLOR]","[COLOR white][B]20Mbps+[/B][/COLOR] [COLOR blue]sind fuer alle Streams optimal[/COLOR]" )
  self . close ( )
  if 74 - 74: O0 / i1IIi
...
class ii1O0 ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  ...
  if 45 - 45: ooO00oOoo
  OOo = xbmcgui . Dialog ( )
  OOo . ok ( "[COLOR white]Storm Wizard [B]Speed Test[/COLOR][/B]" ,"[COLOR red][B]7Mbps[/B] und weniger sind fuer SD-Streams ok [/COLOR]", "[COLOR yellow][B]10-15Mbps[/B] sind fuer HD-Streams ok[/COLOR]","[COLOR lime][B]20Mbps+[/B] sind fuer alle Streams optimal[/COLOR]" )
  self . close ( )
